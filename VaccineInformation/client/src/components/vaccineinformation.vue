...
<v-card style="width:60%; margin:auto; background-color:#FFFFFF">
  <v-container>
        ...
        <v-form v-model="valid" ref="form">
          ...
          <v-row justify-center>
            ...
            <v-row justify-right>
              <v-col cols="3">
                <!-- <v-btn-toggle group > -->
                  <v-btn @click="saveVaccineinformation" style="color:#FFFFFF" :class="{ red: !valid, green: valid } ">บันทึก</v-btn>
              </v-col>
              <v-spacer></v-spacer>
               <v-col cols="3">                  
              ...
              <v-spacer></v-spacer>
               <v-col cols="3">   
                  <v-btn @click="viewvaccineinformation" color="#000000" style="color:#FFFFFF">ดูบันทึก</v-btn>
                <!-- </v-btn-toggle> -->
              </v-col>
            </v-row>
          <br />
