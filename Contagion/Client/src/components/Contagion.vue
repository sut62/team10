            ...
            <v-form>                    
                <v-layout wrap column>                                            
                    <v-toolbar-title class="headline text-uppercase">         
                        <br><h2>ระบบเก็บข้อมูลโรคติดต่อ</h2><br>
                    </v-toolbar-title>
...
export default {
    ...
    methods: {
        ...
        saveContagion() {
            console.log(this.contagion.diseaseid)      
            console.log(this.contagion.typeid)
            console.log(this.contagion.carrier)
            console.log(this.contagion.symptomid)
            console.log(this.contagion.rateid)
            http
                .post(
                    "/contagion/" +
